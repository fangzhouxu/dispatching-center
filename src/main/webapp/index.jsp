...
<%@ include file="/WEB-INF/pages/base/common.jspf" %>
</head>
<script type="text/javascript" src ="${pageContext.request.contextPath}/static/js/angularjs/angular.min.js" ></script>
<script type="text/javascript" src ="${pageContext.request.contextPath}/static/js/angularjs/angular-route.min.js" ></script>
...
<div class="navbar navbar-default" id="navbar">
					...
					<ul class="nav ace-nav">
						...
						<li class="green">
							...
							<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li>
									<a href="#">
										<img src="${pageContext.request.contextPath}/static/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
										<span class="msg-body">
								...
								<li>
									<a href="#">
										<img src="${pageContext.request.contextPath}/static/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
								...
								<li>
									<a href="#">
										<img src="${pageContext.request.contextPath}/static/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
								...
								<li>
									<a href="${pageContext.request.contextPath}/inbox.html">
										查看所有消息
										<i class="icon-arrow-right"></i>
									</a>
								</li>
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="${pageContext.request.contextPath}/static/avatars/user.jpg" alt="Jason's Photo" />
					...
					<!-- <ul class="nav nav-list">
						...
						<li >
							<a href="#" class="dropdown-toggle">
								...
								<span class="menu-text">服务器配置</span>
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='${pageContext.request.contextPath}/static/js/jquery-2.0.3.min.js'>"+"<"+"script>");
		</script>
...
<![endif]-->
	...
	<script src='${pageContext.request.contextPath}/static/js/stat.js' language='JavaScript' charset='gb2312'>
	</script></div>
</body>
</html>